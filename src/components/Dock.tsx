...
import { Calendar, CalendarRange, Inbox, List, Network, Plus, RefreshCw, Settings as SettingsIcon } from "lucide-react";
...
const META: Record<Exclude<ViewKind, "issue">, string> = { calendar: "Calendar", list: "Issues", "this-week": "Overview", graph: "Dependencies", inbox: "Inbox", settings: "Settings" };
