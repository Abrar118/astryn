...
function makeLinkMarkView(
  ...
  return (mark: ProseMirrorMark, _view: EditorView, _inline: boolean) => {
    ...
    if (identifier && target) {
      ...
      dom.setAttribute("data-mention-pill", "");
      ...
      // contentDOM: ProseMirror places the link's inner text here
...
/**
 * Milkdown plugin that installs the issue-mention link mark view.
 *
